...
RSpec.describe InspectionTemplatesController, type: :controller do
  ...
  # InspectionTemplatesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested inspection_template as @inspection_template" do
      inspection_template = InspectionTemplate.create! valid_attributes
      get :show, {:id => inspection_template.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested inspection_template as @inspection_template" do
      inspection_template = InspectionTemplate.create! valid_attributes
      get :edit, {:id => inspection_template.to_param}, valid_session
      expect(assigns(:inspection_template)).to eq(inspection_template)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new InspectionTemplate" do
        expect {
          post :create, {:inspection_template => valid_attributes}, valid_session
    ...
    #     post :create, {:inspection_template => invalid_attributes}, valid_session
    #     expect(assigns(:inspection_template)).to be_a_new(InspectionTemplate)
    #   end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested inspection_template" do
        inspection_template = InspectionTemplate.create! valid_attributes
        put :update, {:id => inspection_template.to_param, :inspection_template => new_attributes}, valid_session
      ...
      it "assigns the requested inspection_template as @inspection_template" do
        inspection_template = InspectionTemplate.create! valid_attributes
        put :update, {:id => inspection_template.to_param, :inspection_template => valid_attributes}, valid_session
        expect(assigns(:inspection_template)).to eq(inspection_template)
      end
    ...
    #     inspection_template = InspectionTemplate.create! valid_attributes
    #     put :update, {:id => inspection_template.to_param, :inspection_template => invalid_attributes}, valid_session
    #     expect(assigns(:inspection_template)).to eq(inspection_template)
    #   end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested inspection_template" do
      inspection_template = InspectionTemplate.create! valid_attributes
      expect {
        delete :destroy, {:id => inspection_template.to_param}, valid_session
      }.to change(InspectionTemplate, :count).by(-1)
    end
